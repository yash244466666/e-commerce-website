...
Clone this [repository](https://github.com/yash244466666/e-commerce-website.git) to your desired folder:

```sh
  cd my-folder
  git clone git@github.com:yash244466666/e-commerce-website.git
  cd book-store
```
...
Feel free to check the [issues page](https://github.com/yash244466666/e-commerce-website/issues).
